...
export default function Home() {
  return (
    <div className="max-w-[1024px] mx-auto px-4">
      <div className="h-[calc(100vh-73.4px)] text-center flex flex-col justify-center">
        <h1 className="text-3xl lg:text-6xl font-semibold mb-6 max-w-[900px] mx-auto">
          Kerja Sesuai Keahlian, Bayaran Sesuai Harapan!
        </h1>
        <p className="w-full max-w-[700px] mx-auto lg:text-xl mb-8">
          Gabung dengan ribuan tenaga kerja informal & freelancer yang menemukan
